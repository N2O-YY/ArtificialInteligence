...
ax.grid()
fig.savefig("test_loss_res.png")

print(test_acc)
x = np.arange(len(test_acc))
fig, ax = plt.subplots()
ax.plot(x, test_acc, color='orange')
ax.set(xlabel='episode',
       ylabel='test_acc',
       title='test_acc for every episode')
ax.grid()
fig.savefig("test_acc_res.png")
